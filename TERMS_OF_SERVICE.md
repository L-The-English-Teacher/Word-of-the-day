...
This Terms of Service Agreement (the "Agreement") is entered into between [L-The-English-Teacher] ("Bot Owner") and the user ("User") of the [Word of the day] Discord bot (the "Bot").
